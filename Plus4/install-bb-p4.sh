...
OPT_DEFAULT_CALIB=""   # yes | no  (seed vetted stock-Plus4 default calibration)
...
Options:
  ...
  --default-calibration=yes|no
                             Seed Bunny Box's vetted stock-Plus4 calibration
...
# =========================================================================
# A starting set of calibration values for STOCK Plus4 + stock Qidi Box
...
if calib_has_values "$DEFAULTS_CALIB"; then
    echo ""
    echo "==> Optional: seed vetted default calibration (stock Plus4 + stock Box)"
