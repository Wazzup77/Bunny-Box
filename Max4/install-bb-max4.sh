...
OPT_DEFAULT_CALIB=""   # yes | no  (seed vetted stock-Max4 default calibration)
...
Options:
  ...
  --default-calibration=yes|no
                             Seed Bunny Box's vetted stock-Max4 calibration
...
# =========================================================================
# A starting set of calibration values for STOCK Max4 + stock Qidi Box
...
if calib_has_values "$DEFAULTS_CALIB"; then
    echo ""
    echo "==> Optional: seed vetted default calibration (stock Max4 + stock Box)"
...
echo ""
echo "On the Max4 you MUST do this before your first print:"
